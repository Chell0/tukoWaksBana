"""
Django settings for tukoWaks project.
...
DATABASES={ 'default':  dj_database_url.config(default='postgres://test@localhost/blog', conn_max_age=500)}
...
WSGI_APPLICATION = 'tukoWaks.wsgi.application'
